...
import TheLeftComponent from "./TheLeftComponent";
import TheMiddleCardsComponent from "./TheMiddleCardsComponent";
import TheRightStaticComponent from "./TheRightStaticComponent";

export default function TheMainComponent() {
  ...
  return (
    <div className="font-ubuntu flex flex-row justify-between">
      {/* left component */}
      <TheLeftComponent />

      {/* middle component */}
      <TheMiddleCardsComponent data={place} setPlace={setPlace} />

      {/* right */}
      <TheRightStaticComponent />
    </div>
  );
}
